"""CLI: cross-sectional momentum backtest with walk-forward validation."""
...
def main() -> int:
    ...
    print(
        ...
        f"signal=12-{args.skip_months}m)..."
    )
    oos_equity, folds = walk_forward_multi(
        ...
        warmup_bars=(args.lookback_months + args.skip_months) * 21 + 5,
    ...
    output = args.output or RESULTS_DIR / f"momentum_{timestamp}.parquet"
